...
class TApplication(QApplication):
    ...
    def __read_matrix(self):
        ...
        str_matrix = ""
        for i in range(self.__interface.vert_size):
            for j in range(self.__interface.hor_size):
                ...
                if j != self.__interface.hor_size - 1:
                    str_matrix = str_matrix + ' '

            if i != self.__interface.vert_size - 1:
                str_matrix = str_matrix + "|"
        return str_matrix
    ...
    def __transpose(self):
        ...
        str_message = "trans#" + f'{self.__interface.type}#' + str_matrix
    ...
    def __show_det(self):
        ...
        str_matrix = self.__read_matrix()
        str_message = "det#" + f'{self.__interface.type}#' + str_matrix
        self.__communicator.send_message(str_message)
    ...
    def __show_rank(self):
        ...
        str_matrix = self.__read_matrix()
        str_message = "rank#" + f'{self.__interface.type}#' + str_matrix
        self.__communicator.send_message(str_message)
